...
import { CreateExpense, Expense, UpdateExpense } from '@/models/expense/IExpense'

class ExpenseService {
  public async insert (expense: CreateExpense, userId: number): Promise<void> {
  ...
  public async update (expense: UpdateExpense, userId: number): Promise<void> {
    const expenseForm = expense
